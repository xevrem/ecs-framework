...
declare type ComponentBuilderFunction = (builder: EntityBuilder) => Component;
declare type ComponentMaybeBuilderFunction = (
  builder: EntityBuilder
) => Option<Component>;
declare type StringBuilderFunction = (builder: EntityBuilder) => string;
declare type DataBuilderFunction = (builder: EntityBuilder) => EntityBuilder;
