System.register("Bag", [], function (exports_1, context_1) {
    "use strict";
    var Bag;
...
System.register("Component", [], function (exports_2, context_2) {
    ...
    exports_2("isComponent", isComponent);
    /**
    ...
    exports_2("isComponentOfType", isComponentOfType);
    return {
        setters: [],
        execute: function () {
            exports_2("ComponentSymbol", ComponentSymbol = Symbol('Component'));
...
System.register("EntityManager", ["Bag", "Entity"], function (exports_4, context_4) {
    "use strict";
    var Bag_1, Entity_1, EntityManager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_4("default", EntityManager);
        }
    };
});
System.register("Query", [], function (exports_5, context_5) {
    "use strict";
    var Query;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("Query", Query);
        }
    };
});
System.register("EntitySystem", ["Bag", "Query"], function (exports_6, context_6) {
    "use strict";
    var Bag_2, Query_1, EntitySystem;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_6("EntitySystem", EntitySystem);
        }
    };
});
System.register("SystemManager", [], function (exports_7, context_7) {
    "use strict";
    var SystemManager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_7("SystemManager", SystemManager);
        }
    };
});
System.register("TagManager", [], function (exports_8, context_8) {
    "use strict";
    var TagManager;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_8("TagManager", TagManager);
        }
    };
});
System.register("GroupManager", ["Bag"], function (exports_9, context_9) {
    "use strict";
    var Bag_3, GroupManager;
    ...
    return {
        ...
        execute: function () {
            GroupManager = class GroupManager {
                ...
                addEntityToGroup(group, entity) {
                    if (!this._groups[group]) {
                        this._groups[group] = new Bag_3.Bag();
                    }
            ...
            exports_9("GroupManager", GroupManager);
        }
    };
});
System.register("ComponentMapper", [], function (exports_10, context_10) {
    "use strict";
    var ComponentMapper;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_10("ComponentMapper", ComponentMapper);
        }
    };
});
System.register("Scheduler", [], function (exports_11, context_11) {
    "use strict";
    var Scheduler;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_11("Scheduler", Scheduler);
        }
    };
});
System.register("FuncQuery", [], function (exports_12, context_12) {
    "use strict";
    var FuncQuery;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("FuncQuery", FuncQuery);
        }
    };
});
System.register("utils", [], function (exports_13, context_13) {
    ...
    exports_13("is_some", is_some);
    function is_none(val) {
        if (is_some(val))
            return false;
        return true;
    }
    exports_13("is_none", is_none);
    function is_ok(val) {
        if (val instanceof Error)
            return false;
        return true;
    }
    exports_13("is_ok", is_ok);
    function is_err(val) {
        if (val instanceof Error)
            return true;
        return false;
    }
    exports_13("is_err", is_err);
    function all_some(val) {
        if (val.some(v => is_none(v)))
            return false;
        return true;
    }
    exports_13("all_some", all_some);
    function all_none(val) {
        if (val.some(v => is_some(v)))
            return false;
        return true;
    }
    exports_13("all_none", all_none);
    function lerp(a, b, percent) {
        return (b - a) * percent + a;
    }
    exports_13("lerp", lerp);
    ...
    exports_13("makeTimer", makeTimer);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("EntityBuilder", ["utils", "Bag"], function (exports_14, context_14) {
    "use strict";
    var utils_1, Bag_4;
    ...
    function makeEntityBuilder(ecs) {
        let entity;
        const alsoCallbacks = [];
        const components = new Bag_4.Bag();
    ...
    exports_14("makeEntityBuilder", makeEntityBuilder);
    return {
        setters: [
            function (utils_1_1) {
                utils_1 = utils_1_1;
...
System.register("EcsInstance", ["EntityManager", "ComponentManager", "SystemManager", "TagManager", "GroupManager", "ComponentMapper", "Scheduler", "Bag", "EntityBuilder", "FuncQuery", "utils"], function (exports_15, context_15) {
    "use strict";
    var EntityManager_1, ComponentManager_1, SystemManager_1, TagManager_1, GroupManager_1, ComponentMapper_1, Scheduler_1, Bag_5, EntityBuilder_1, FuncQuery_1, utils_2, timer, EcsInstance;
    ...
    return {
        setters: [
            ...
            function (SystemManager_1_1) {
                SystemManager_1 = SystemManager_1_1;
            },
            function (TagManager_1_1) {
                TagManager_1 = TagManager_1_1;
            },
            function (GroupManager_1_1) {
                GroupManager_1 = GroupManager_1_1;
            },
            function (ComponentMapper_1_1) {
                ComponentMapper_1 = ComponentMapper_1_1;
            },
            ...
            function (EntityBuilder_1_1) {
                EntityBuilder_1 = EntityBuilder_1_1;
            },
            function (FuncQuery_1_1) {
                FuncQuery_1 = FuncQuery_1_1;
            },
            function (utils_2_1) {
                utils_2 = utils_2_1;
            }
        ...
        execute: function () {
            timer = utils_2.makeTimer(1);
            EcsInstance = class EcsInstance {
                constructor() {
                    this._destroyed = false;
                    this.qSysTuple = [];
                    this.entityManager = new EntityManager_1.EntityManager();
                    this.componentManager = new ComponentManager_1.ComponentManager(this);
                    this.systemManager = new SystemManager_1.SystemManager(this);
                    this.tagManager = new TagManager_1.TagManager();
                    this.groupManager = new GroupManager_1.GroupManager();
                    this.scheduler = new Scheduler_1.Scheduler();
                    this._creating = new Bag_5.Bag();
                    this._resolving = new Bag_5.Bag();
                    this._deleting = new Bag_5.Bag();
                    this._updatingEntities = [];
                    this._updating = new Bag_5.Bag();
                    this._delta = 0;
                    this._lastTime = 0;
                    this._elapsed = 0;
                }
                ...
                create() {
                    return EntityBuilder_1.makeEntityBuilder(this);
                }
                /**
                 * delete an entity
                 * @param entity the entity to delete
                ...
                makeMapper(component) {
                    return new ComponentMapper_1.ComponentMapper(component, this);
                }
                /**
                ...
                initialResolve() {
                    ...
                    this._creating = new Bag_5.Bag(creating.capacity);
                ...
                resolveEntities() {
                    ...
                    this._deleting = new Bag_5.Bag(deleting.capacity);
                    this._resolving = new Bag_5.Bag(resolving.capacity);
                    this._updating = new Bag_5.Bag(updating.capacity);
                    this._updatingEntities = [];
                    if (deleting.count > 0) {
                ...
                update(component, ignoredSystems = []) {
                    if (!this._updating.has(component.owner))
                        this._updating.set(component.owner, new Bag_5.Bag());
                    ...
                    for (let i = ids.length; i--;) {
                        ...
                        if (needed) {
                            for (let j = 0; j < needed.length; j++) {
                                ...
                                valid = (value && valid);
                                if (!valid || utils_2.is_none(value))
                                    break;
                                result.push(value);
                            }
                            if (!valid)
                ...
                *query(needed) {
                ...
                runQuerySystems() {
                    for (let i = 0; i < this.qSysTuple.length; i++) {
                        ...
                        timer.begin();
                        func({
                            query: new FuncQuery_1.FuncQuery(this, data),
                            ecs: this,
                            delta: this._delta,
                        });
            ...
            exports_15("EcsInstance", EcsInstance);
        }
    };
});
System.register("ComponentManager", ["Bag"], function (exports_16, context_16) {
    "use strict";
    var Bag_6, ComponentManager;
        ...
        execute: function () {
            ComponentManager = class ComponentManager {
                constructor(ecsInstance) {
                    ...
                    this._ecsInstance = ecsInstance;
                    this._components = new Bag_6.Bag();
                    this._nextTypeId = 0;
                }
                get allTypes() {
                ...
                registerComponent(component) {
                    ...
                    if (!this._components.has(component.type)) {
                        this._components.set(component.type, new Bag_6.Bag());
                    }
                }
                /**
            ...
            exports_16("ComponentManager", ComponentManager);
        }
    };
});
System.register("EcsRig", ["Component", "EcsInstance", "EntitySystem"], function (exports_17, context_17) {
    "use strict";
    var Component_1, EcsInstance_1, EntitySystem_1, Bar;
    var __moduleName = context_17 && context_17.id;
    function ecsRig(callback) {
        const rig = {
            ecs: new EcsInstance_1.EcsInstance(),
            makeComponentType: () => {
                return class Foo extends Bar {
                };
            },
            makeSystemType: (query) => {
                class Sys extends EntitySystem_1.EntitySystem {
                    constructor() {
                        super(...arguments);
    ...
    exports_17("default", ecsRig);
    return {
        setters: [
            function (Component_1_1) {
                Component_1 = Component_1_1;
            },
            function (EcsInstance_1_1) {
                EcsInstance_1 = EcsInstance_1_1;
            },
            function (EntitySystem_1_1) {
                EntitySystem_1 = EntitySystem_1_1;
            }
        ],
        execute: function () {
            Bar = class Bar extends Component_1.Component {
            };
        }
    };
});
System.register("index", ["Bag", "Component", "ComponentManager", "ComponentMapper", "EcsInstance", "Entity", "EntityBuilder", "EntityManager", "EntitySystem", "FuncQuery", "GroupManager", "SystemManager", "TagManager", "Query", "Scheduler", "utils"], function (exports_18, context_18) {
    "use strict";
    ...
    return {
        setters: [
            function (Bag_7_1) {
                exportStar_1(Bag_7_1);
            },
            function (Component_2_1) {
                exportStar_1(Component_2_1);
            },
            function (ComponentManager_2_1) {
                exportStar_1(ComponentManager_2_1);
            },
            function (ComponentMapper_2_1) {
                exportStar_1(ComponentMapper_2_1);
            },
            function (EcsInstance_2_1) {
                exportStar_1(EcsInstance_2_1);
            },
            function (Entity_2_1) {
                exportStar_1(Entity_2_1);
            },
            function (EntityBuilder_2_1) {
                exportStar_1(EntityBuilder_2_1);
            },
            function (EntityManager_2_1) {
                exportStar_1(EntityManager_2_1);
            },
            function (EntitySystem_2_1) {
                exportStar_1(EntitySystem_2_1);
            },
            function (FuncQuery_2_1) {
                exportStar_1(FuncQuery_2_1);
            },
            function (GroupManager_2_1) {
                exportStar_1(GroupManager_2_1);
            },
            function (SystemManager_2_1) {
                exportStar_1(SystemManager_2_1);
            },
            function (TagManager_2_1) {
                exportStar_1(TagManager_2_1);
            },
            function (Query_2_1) {
                exportStar_1(Query_2_1);
            },
            function (Scheduler_2_1) {
                exportStar_1(Scheduler_2_1);
            },
            function (utils_3_1) {
